...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-celery-results-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10287&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-celery-results-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-celery-results` can be installed with:

```
conda install django-celery-results
```

It is possible to list all of the versions of `django-celery-results` available on your platform with:
